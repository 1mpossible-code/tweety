...
Toast.add = function (params) {
  ...
  if (!document.querySelector('.toasts')) {
    ...
    container.style.cssText = 'position: fixed; top: 100%; right: 15px; width: 250px;';
  ...
  var toast = new Toast(toasts[toasts.length - 1], { autohide: config.autohide, delay: config.delay });
    console.log(document.querySelector('.toasts').style.top )
    document.querySelector('.toasts').style.top = 'calc(' + document.querySelector('.toasts').style.top + ' - 10%)';
